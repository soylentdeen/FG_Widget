...
function mrdfits2, file, extension, header,      $
        structyp = structyp,                    $
...
; Check positional arguments.
   ...
   if n_params() le 0  or n_params() gt 3 then begin
        print, 'MRDFITS: Usage'
        print, '   a=mrdfits(file, [extension, header],         $'
        print, '       /fscale, /dscale, /use_colnum, /silent    $'
        print, '       range=, tempdir=, structyp=, columns=, error_action= )'
        return, 0
   endif
...
unit = fxposit(file, extension,/readonly)
