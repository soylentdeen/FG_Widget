...
; CALLING SEQUENCE:
;   
;   fg_writecol, filename, v1, v2, FMT=''
;
; INPUTS:
...
;
; EXAMPLES:
;   fg_writecol, 'arrays.dat', array1, array2
;
;
; PROCEDURES CALLED:
;
...
;-
;------------------------------------------------------------------------------
pro fg_writecol, file, v1, v2, v3, v4, v5, v6, v7, v8, v9, $
              v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, $
              FMT=fmt, FILNUM=filnum


; fg_writecol -- Writes a 2 column ascii file

  if (N_params() LT 2) then begin 
    print,'Syntax - ' + $
             'fg_writecol, file, v1, v2, [v3-v19] FMT=, FILNUM= '
    return
  endif 
...
print,"FG_WRITECOL: File Written: ", file
return
end
