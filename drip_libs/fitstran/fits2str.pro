FUNCTION fits2str,infile

; 23 Jul 04 created by modifiying latest version of fits2isap
; 22 Jun 04 name changed from fits2yar to fits2isap
; 10 Oct 03 created as fits2yar
;
; fits2str reads in a spectral FITS file and converts it to a YAAAR structure
; input
