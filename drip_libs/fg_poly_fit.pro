; $Id: fg_poly_fit.pro,v 1.16 2003/05/16 17:27:36 chris Exp $
;+
; NAME:
;   FG_POLY_FIT
;
...
;
; OUTPUTS:
;   FG_POLY_FIT returns a vector of coefficients with a length of NDegree+1.
;
; KEYWORDS:
...
FUNCTION fg_POLY_FIT, x, y, ndegree, $
    ...
    haveYband = ARG_PRESENT(yband) or ARG_PRESENT(yband_old)
