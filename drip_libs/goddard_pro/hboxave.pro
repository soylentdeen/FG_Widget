pro hboxave, oldim, oldhd, newim, newhd, box   ;Boxaverage and update header
;+
; NAME:
;	HBOXAVE
; PURPOSE:
...
;- 
 ...
 if ( npar LT 2 ) then begin		;Check # of parameters
     print,'Syntax: HBOXAVE, oldim, oldhd, [ newim, newhd, box ]
     print,'    or  HBOXAVE, oldim, oldhd, [ box ]
     return
 endif
...
; Update astrometry info if it exists
 ...
 if (noparams EQ 0) or ( noparams EQ 1) then begin 
    ...
    cd = astr.cd
    sxaddpar, newhd, 'CD1_1', cd[0,0]*box, FORMAT='(E14.7)'
    sxaddpar, newhd, 'CD1_2', cd[0,1]*box, FORMAT='(E14.7)'
    sxaddpar, newhd, 'CD2_1', cd[1,0]*box, FORMAT='(E14.7)'
    sxaddpar, newhd, 'CD2_2', cd[1,1]*box, FORMAT='(E14.7)'
