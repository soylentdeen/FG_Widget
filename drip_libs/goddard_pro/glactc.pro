pro glactc,ra,dec,year,gl,gb,j
;+
; NAME:  
;	GLACTC
; PURPOSE:
...
;	ra       right ascension, hours, scalar or vector
;	dec      declination, degrees,scalar or vector
;	gl       galactic longitude (system II), degrees, scalar or vector
;	gb       galactic latitude (system II), degrees, scalar or vector
;
