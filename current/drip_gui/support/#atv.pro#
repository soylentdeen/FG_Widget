...
;
;       This version is 2.0b4, last modified November 27 2007.
;  
...
state = {                   $
        version: '2.0b4', $     ; version # of this release
...
crpix = float(sxpar(*state.head_ptr,'CRPIX1', /silent))
...
filterlist = ['*.fits;*.fit;*.fit.gz;*.fits.gz;*.FIT;*.FITS;*.ftz;*.FTZ;*.ccd']
