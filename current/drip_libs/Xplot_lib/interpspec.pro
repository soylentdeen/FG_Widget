...
;
; CALLING SEQUENCE:
;     interpspeec,xa,ya,x,y,[yerror],YAERROR=yaerror,CANCEL=cancel
;
; INPUTS:
...
;-
pro interpspec,xa,ya,x,y,yerror,YAERROR=yaerror,CANCEL=cancel
...
if cancel then return
cancel = cpar('interpspec',x,3,'X',[2,3,4,5],1)
if cancel then return
