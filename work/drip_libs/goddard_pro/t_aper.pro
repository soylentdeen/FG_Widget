pro t_aper,image,fitsfile,apr,skyrad,badpix,PRINT=print,SILENT=silent, $
	NEWTABLE = newtable, SETSKYVAL = setskyval
;+
; NAME:
;	T_APER
; PURPOSE:
...
;-
 ...
 if N_params() LT 2 then begin
    ...
    print,'                    SETSKY = ,PRINT = , NEWTABLE = ,/SILENT ]'
  return
 endif
 ...
 aper, image, xc, yc, mags, errap, sky, skyerr, phpadu, apr, skyrad,$
       badpix, PRINT = print, SILENT=silent, SETSKYVAL = setskyval
